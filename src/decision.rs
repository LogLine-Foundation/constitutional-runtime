...
//!
//! Runtime [`StandardRuntimeLowerer`](crate::lowering::StandardRuntimeLowerer) intentionally does **not**
//! lower `Decide`. This module is the constitutional place for that translation.

use crate::ir::{IRPrimitive, IrNode};
use crate::lowering::{
    Lowerer, LoweringError, LoweringPlan, StandardRuntimeLowerer, OperationalCommand,
};
